...
public class sua extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        vandongvien vdv = cn.getById(mavdv);
        request.setAttribute("vdv", vdv);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String mavdv = request.getParameter("mavdv");
        String tenvdv = request.getParameter("tenvdv");
        String bomon = request.getParameter("bomon");
        String ngaysinh = request.getParameter("ngaysinh");
        String sohc = request.getParameter("sohc");

        vandongvien vdv = new vandongvien(mavdv, tenvdv, bomon, ngaysinh, sohc);

       
        cn.update(vdv); // bạn phải có phương thức update() trong DAO
